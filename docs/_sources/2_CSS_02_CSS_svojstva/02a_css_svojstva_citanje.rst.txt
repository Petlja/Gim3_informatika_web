...
.. comment
    ...
    ако је дефаулт пиксел, онда треба навести cm ѕа центиметре?
    
**Вредности димензија** су нумеричке вредности које се изражавају у пикселима (нпр. ``12px``), тачкама (нпр. ``10``), центиметрима (нпр. ``20``) и слично (више информација се може наћи на *W3CSchools* сајту). Некада се користи јединица ``ЕМ`` за релативну величину слова и која зависи од подразумеване величине слова. Нпр. ``1.2 ЕМ`` значи да ће величина бити за 20% увећана у односу на вредност која би била употребљена без навођења ове вредности.

**Вредности боја** се могу дефинисати на више начина (више информација се може наћи на *W3CSchools* сајту): 
...
- ``block`` елементе као што су ``<p>``, ``<table>``, ``<ul>``, ``<ol>``, или ``<div>``, који заузимају сву ширину која им је на располагању. Подразумевано понашање ових елемената је да се увек позиционирају у новом реду, ширина им је навећа могућа у надређеном елементу, а висина им зависи од количине садржаја. 
