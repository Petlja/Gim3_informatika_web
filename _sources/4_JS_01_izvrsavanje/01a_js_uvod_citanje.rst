...
Пример који смо видели је дат само као најава онога што ћемо радити у следећим лекцијама, а то је (убрзано) упознавање основа језика *JavaScript*. Хајде да почнемо да пишемо *JavaScript* програме!
