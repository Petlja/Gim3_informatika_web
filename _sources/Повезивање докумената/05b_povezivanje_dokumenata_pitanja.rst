...
.. fillintheblank:: linkovi_q4
    ...
    Који симбол раздваја адресу веб стране и идентификатор секције на страни?
...
.. mchoice:: linkovi_q5
    ...
    :answer_d: Апсолутни линк може да се прекопира и употреби на било ком другом месту.
    :correct: a, c, d
