...
Вероватно ћете у програмима на језику *JavaScript* наилазити и на операторе ``==`` и ``!=``, који такође служе за проверу да ли су две вредности једнаке, односно да ли су различите. За разлику од претходних, код ових оператора се пре поређења покушава свођење двеју вредности на исти тип. Упоредимо резултат извршавања претходног примера са следећим:
